...
class ButtonBar(QToolBar):
    ...
    def change_mode(self, mode):
        ...
        self.addAction(name="saveas", display_name=_("Save As"),
                       tool_text=_("Save the current Python script as a new file."))
        self.addSeparator()
...
class FileTabs(QTabWidget):
    ...
    def removeTab(self, tab_id):
        ...
        if modified:
            msg = _('There is un-saved work, closing the tab will cause you '
                   'to lose it.')
